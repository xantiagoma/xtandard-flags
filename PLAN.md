...
Single source of truth for _what we are building and in what order_. Day-to-day
...
- **P1 Core** — schema, validation, hash, evaluator, snapshot + unit/type tests. _Highest priority (eval correctness)._
...
- **P10 Docs, examples, CI/CD** — README, docs/_, examples/_, GH Actions (ci/release/docker).
